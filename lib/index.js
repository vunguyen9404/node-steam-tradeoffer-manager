 ...
 * @param callback
 */
TradeOfferManager.prototype.getUserInventoryContentsWithProxy = function(sid, appid, contextid, tradableOnly, proxy, count, callback) {
	this._community.getUserInventoryContentsWithProxy(sid, appid, contextid, tradableOnly, this._languageName || "english", proxy, count, callback);
};
